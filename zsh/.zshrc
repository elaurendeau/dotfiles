...
alias ods="cd ~/workspace/ods"
alias odspp="ods && cd ods-microservice-paypro-transaction-history"
...
alias gsa="find . -maxdepth 3 -name .git -type d | rev | cut -c 6- | rev | xargs -I {} sh -c 'echo \"\\n\"; echo {}; git -C {} status -s -b'"
